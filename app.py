...
class enfrtrans():
    def __init__(self, model_path):
        ...
        with open("C:/Users/IT Capital/Desktop/Machine_translation/tokenizer_eng.pkl", 'rb') as handle:
            self.tokenizer_eng = pickle.load(handle)
        with open('C:/Users/IT Capital/Desktop/Machine_translation/tokenizer_fr.pkl', 'rb') as handle:
